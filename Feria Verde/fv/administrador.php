...
<html lang="es">
<head>
	<title>Administrador | Feria Verde</title>
	<meta charset="utf-8">
	...
	<div class="container">
		<div class="row">
			<div class="text-center">
				<h1>Bienvenido administrador: <?php echo $_SESSION['user']; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="text-center">
				<div class="form-group">
					<a class="btn btn-info btn-lg" href="admin_fer.php"><img src="img/feriantes.png" width="70"> Feriantes</a>
				</div>
				<div class="form-group">	
